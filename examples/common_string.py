...
# تعريف الدالة LCS باستخدام النهج التكراري
...
# تعريف الدالة LCS باستخدام التخزين المؤقت
...
# تعريف الدالة LCS باستخدام البرمجة الديناميكية
def lcs_dynamic(x, y):
    m, n = len(x), len(y)
...
# إنشاء السلاسل النصية باستخدام المولد
