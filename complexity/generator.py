...
class StringGenerator(DataGenerator):
    ...
    def generate_pair(self, len1: int, len2: int) -> tuple[str, str]:
        ...
        str1 = "".join(random.choices(self.alphabet, k=len1))
        str2 = "".join(random.choices(self.alphabet, k=len2))
        return str1, str2

class GraphGenerator(DataGenerator):
    def __init__(self, directed: bool = False, weighted: bool = True):from abc import ABC, abstractmethod
